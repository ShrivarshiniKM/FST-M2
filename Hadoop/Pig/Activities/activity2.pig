...
$ hdfs dfs -put /root/input.txt /user/shrivarshini

-- Load input file from HDFS
inputFile = LOAD 'hdfs:///user/shrivarshini/input.txt' AS (line);
...
rmf hdfs:///user/shrivarshini/results;
-- Store the result in HDFS
STORE cntd INTO 'hdfs:///user/shrivarshini/results';

$ pig /root/activity2.pig
$ hdfs dfs -cat /user/shrivarshini/results/part-r-00000
